...
# sphinx-quickstart on Sun Oct 12 15:58:32 2014.
#
...
project = u'MCSTracker'
copyright = u'2016, Jochen Kursawe'
...
latex_documents = [
  ('index', 'Pythondevelopment.tex', u'Python development Documentation',
   u'Jochen Kursawe', 'manual'),
]
...
man_pages = [
    ('index', 'pythondevelopment', u'Python development Documentation',
     [u'Jochen Kursawe'], 1)
]
...
texinfo_documents = [
  ('index', 'Pythondevelopment', u'Python development Documentation',
   u'Jochen Kursawe', 'Pythondevelopment', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Python development'
epub_author = u'Jochen Kursawe'
epub_publisher = u'Jochen Kursawe'
epub_copyright = u'2014, Jochen Kursawe'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'Python development'
